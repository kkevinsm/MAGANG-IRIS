...
message(STATUS "IRIS: 2 messages, 0 services")

set(MSG_I_FLAGS "-IIRIS:/home/kkevinsm/finalproject_iris/src/IRIS/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSRX.msg" NAME_WE)
add_custom_target(_IRIS_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "IRIS" "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSRX.msg" ""
)

get_filename_component(_filename "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSTX.msg" NAME_WE)
add_custom_target(_IRIS_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "IRIS" "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSTX.msg" ""
)
...
_generate_msg_cpp(IRIS
  "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSRX.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/IRIS
)
_generate_msg_cpp(IRIS
  "/home/kkevinsm/finalproject_iris/src/IRIS/msg/BSTX.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/IRIS
)
